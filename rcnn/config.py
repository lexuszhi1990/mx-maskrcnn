...
dataset.coco.root_path = '/mnt/models/v3'
dataset.coco.alternate_prefix = '/mnt/models/v3'
dataset.coco.dataset_path = '/mnt/data/coco'
dataset.coco.NUM_CLASSES = 81
dataset.coco.CLASS_ID = [i for i in range(dataset.coco.NUM_CLASSES)]
dataset.coco.network = 'resnet_fpn'
dataset.coco.pretrained = '/mnt/models/final'
dataset.coco.SCALES = [(640, 800)]
dataset.coco.vis = True
dataset.coco.base_lr = 0.005
dataset.coco.frequent = 20
dataset.coco.kvstore = 'device'
dataset.coco.e2e_prefix = '/mnt/models/v3/coco-mrcnn'
dataset.coco.e2e_epoch = 2
dataset.coco.e2e_lr = 0.001
dataset.coco.e2e_lr_step = '6'
dataset.coco.rpn_prefix = '/mnt/models/v3/coco-rpn'
dataset.coco.rpn_epoch = 2
dataset.coco.rpn_lr = 0.001
dataset.coco.rpn_lr_step = '6'
dataset.coco.rcnn_prefix = '/mnt/models/v3/coco-rcnn'
dataset.coco.rcnn_epoch = 2
dataset.coco.rcnn_lr = 0.001
dataset.coco.rcnn_lr_step = '20'
...
dataset.fashionai_kp.CLASS_ID = [i for i in range(dataset.fashionai_kp.NUM_CLASSES)]
# default config
