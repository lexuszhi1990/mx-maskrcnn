...
dataset.coco.e2e_prefix = '/mnt/models/mx-maskrcnn/v1/fai'
dataset.coco.e2e_epoch = 2
dataset.coco.e2e_lr = 0.001
dataset.coco.e2e_lr_step = '7'
dataset.coco.rpn_prefix = '/mnt/models/mx-maskrcnn/v1/fai-rpn'
dataset.coco.rpn_epoch = 2
dataset.coco.rpn_lr = 0.001
dataset.coco.rpn_lr_step = '6'
dataset.coco.rcnn_prefix = '/mnt/models/mx-maskrcnn/v1/fai-rcnn'
